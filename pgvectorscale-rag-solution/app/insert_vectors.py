...
# Configure the API key for generative AI client
...
# Skip deletion of embeddings (remove or comment the next line)
# vec.delete(delete_all=True)  # Commented out to skip deletion

logging.info("Skipping deletion of embeddings")
